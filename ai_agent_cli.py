...
🌐 الموقع: https://www.aau.edu.jo/ar"""
    ...
    "technest_info": {
        "keywords": ["تكنيست", "فريق", "من أنتم", "من أنتو", "من انتو", "من انتم", "من هم", "من هي", "من هو", "من هو فريق تكنيست", "من هي تكنيست", "من هو تكنيست", "من هي فريق تكنيست", "من هو فريق تكنيست", "من هم تكنيست", "من هم فريق تكنيست", "من هم فريق تكنيست؟", "من انتم تكنيست", "من انتم فريق تكنيست", "من أنتو تكنيست", "من أنتو فريق تكنيست", "من أنت تكنيست", "من أنت فريق تكنيست", "من أنت", "من انت"],
        "info": """فريق TechNest 🚀 هو فريق مبدع وشغوف من جامعة عمان العربية، متخصص في تطوير الألعاب! نحن نجمع بين الشغف بالابتكار والخبرة الأكاديمية لتقديم تجارب لعب فريدة وممتعة. نحن فخورون بأن نكون جزءاً من مجتمع الجامعة ونساهم في إثراء عالم الألعاب بابتكاراتنا. فريق رائع ومبدع!"""
    },
    "technest_website": {
        "keywords": ["موقعكم", "موقع", "رابط", "ويب سايت", "website", "link", "technestjo.dev"],
        "info": """بالتأكيد! يمكنك زيارة موقع فريق TechNest على الرابط التالي: 🌐 https://technestjo.dev"""
    },
    "technest_join": {
        "keywords": ["انضمام", "انضم", "كيف انضم", "كيف انضم لكم", "كيف انضم للفريق", "كيف انضم لفريقكم", "join", "join us", "انضم إلينا"],
        "info": """يسعدنا اهتمامك بالانضمام إلى فريق TechNest! 🎮 يمكنك زيارة صفحة الانضمام الخاصة بنا لمعرفة المزيد عن كيفية الانضمام والمتطلبات: 🔗 https://technestjo.dev/join-us"""
    }
}
...
- اذكر فريق TechNest بإيجابية واعتزاز، فهم فريق رائع ومبدع من جامعة عمان العربية!"""
